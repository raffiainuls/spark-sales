...
from etl.branch_weeakly_finance_performance.sql import process_branch_weakly_finance_performance
...
branch_weeakly_finance_performance.show(truncate=False)
...
# atau pakai Delta:
branch_weeakly_finance_performance.write.format("delta").mode("overwrite").save("./data/analytics/branch_weeakly_finance_performance/")
# 7. Sink Postgres
pg_writer = pg_writer()
pg_writer.write_to_postgres(branch_weeakly_finance_performance, table_name="branch_weeakly_finance_performance")
