...
from etl.branch_monthly_finance_performance.sql import process_branch_montlhy_finance_performance
...
branch_monthly_finance_performance.show(truncate=False)
...
# atau pakai Delta:
branch_monthly_finance_performance.write.format("delta").mode("overwrite").save("./data/analytics/branch_monthly_finance_performance/")
# 7. Sink Postgres
pg_writer = pg_writer()
pg_writer.write_to_postgres(branch_monthly_finance_performance, table_name="branch_monthly_finance_performance")
